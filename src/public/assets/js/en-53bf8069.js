const e = {
  ...
  tipSaveKeyProperly:
    "Please keep the key, you will not be able to re-link the new Google Authenticator if you lose the key",
  bindStep: "Link Guide",
  ...
  tipNametheAccountPasteTheKey:
    "Name this account for easy verification, paste the 16 digit key",
  tipGenerateSuccessCode:
    "Automatically generate 6-digit verification code after successful addition",
  ...
  tipEarningsCaculatedEveryMinites:
  ...
  security: "Safe",
  tipFundSaftyEnsuredBySecurityTeam:
  ...
  tipFundEnsuredNtransferOutfreely:
  ...
  noRevenue: "No income",
  tipNoIncomeYetWeatherTransferout:
  ...
  titleInvitationDetail: "my invitation",
  level: "Level",
  checkOver: "Check",
  ...
  tipTop20RankingAdditionalRewords:
    "TOP20 commission rankings will be randomly awarded with {0} a separate bonus",
  tipInterpretationRightSaved:
    "The final interpretation of this activity belongs to {0}",
  titleInvite: "Invite",
  tipSwipeToPickBrochure:
  ...
  tipBindUrOwnCardToEnsureFundSafety:
  ...
  tipVerifyIdentityForFundSafety:
    "To secure your account funds, please fill in and verify your identity first",
  ...
  tipBindUrOwnWalletForFundSafety:
  ...
  tipBindUrOwnUSDEAddrForFundSafety:
    "To ensure the safety of your funds, please link your wallet",
  ...
  tipWithdrawWillBeCompletedIn2Hours:
    "We will complete the withdrawal within 2 hours!",
  ...
  descRewordsBasedOnConsecutiveDays:
  ...
  descActivity2:
    "Invite friends to register and deposit any amount, you can get free points",
  recipientAddr: "Delivery address",
  undone: "Unfinished",
  kindTips: "Reminder",
  descActivity3:
    "To avoid loss to you, please fill in the correct information and contact details.",
  ...
  descRedeem5:
    "Refunds are not supported after successfully redeeming points, please confirm clearly before redeeming;",
  ...
  descRules2:
    "The platform rewards players with bonuses with different proportions of points according to the player's daily bet amount. The higher the bet amount, the higher the bonus proportion",
  goBetting: "Go bet",
  pointsMall: "Mall",
  ...
  descComponents2:
    "Use points to participate in treasure-collecting activities",
  ...
  sendAgain: "Resend",
  vaultdesc1:
    "The daily interest rate is 1%, and earnings are calculated every 5 minutes",
  ...
  instructionDesc1:
    "With fast deposit, each deposit will get an additional bonus.",
  instructionDesc2:
  ...
  instructionDesc3:
    "Note: The number of orders made must be paid correctly, the system will credit it automatically.",
  instructionDesc4:
  ...
  instructionDesc7:
    "USDT, deposit less than the minimum amount will not be credited to the account.",
  instructionDesc8:
  ...
  instructionDesc10:
    "Your deposit address will not change often and you can deposit multiple times.",
  instructionDesc11:
  ...
  instructionDes:
    'Need to bet <span data-v-470caa86 class="red">{0}</span> to be able to withdraw',
  ...
  rechargeUsdtDesc1:
    "This address only supports USDT deposits and does not support other cryptocurrencies",
  ...
  rechargeUsdtDesc5:
    "Please choose a deposit network, if you deposit on another network it will result in loss of funds",
  ...
  validateDesc7:
    "1 to 24 characters, including English letters, uppercase and lowercase letters, Chinese characters, space!",
  ...
  validateDesc21:
    "First and last names must be capitalized without accents and separated by a space!",
  ...
  redeemDialogDesc2:
    "Does not support cancellation after the order is confirmed",
  ...
  k3bet2Desc2:
    "Choose 2 same numbers. If the draw results match your selection, you win (unless 3 numbers are the same).",
  k3bet2Desc3: "A pair of unique numbers: odds",
  k3bet2Desc4:
    "Choose 2 same numbers and 1 different number. If the draw results match your selection, you win.",
  k3bet3Desc1: "3 of the same number: odds",
  k3bet3Desc2:
    "Choose 3 same numbers. If the draw results match your selection, you win.",
  k3bet3Desc3: "Any 3 of the same number: odds",
  k3bet3Desc4: "Any 3 of the same number: odds",
  k3bet3Desc5:
    "Choose any 3 same numbers. If the draw results are any three of the same numbers, you win.",
  ...
  k3bet4Desc4:
    "Choose any 3 consecutive numbers. If the draw results are any three consecutive numbers, you win.",
  ...
  myBet: "My bet",
  stateTips1:
    "You have successfully made a withdrawal request, please wait patiently",
  stateTips2:
    "Your withdrawal has been approved, money is being transferred to you, please wait patiently",
  stateTips3: "Company remarks, reasons why the audit failed!",
  stateTips4:
    "Your request has been successfully submitted, please wait for the review results",
  ...
  code122:
    "Incorrect password attempts have reached the limit and the account is blocked by the system",
  ...
  code207:
    "You have bound your bank account number, please contact customer service to modify it",
  code208:
    "You have bound your e-wallet, please contact customer service to modify it",
  code209:
    "You have bound your USDT wallet, please contact customer service to modify it",
  ...
  code225:
    "You have bound your PIX wallet, please contact customer service to modify it",
  ...
  code283:
    "Only claims in progress_confirmation overdue_can be confirmed received",
  ...
  code316:
    "The balance recovery request time is 10 seconds. Please try again later",
  code317:
    "The time interval to check the balance is 5 seconds. Please try again later",
  ...
  code332:
    "2 all win and Jackpot Mantissa cannot use the multiple selection method",
  ...
  code9308: "Mini games",
  pswRequirements:
    "Password must contain uppercase and lowercase letters, numbers, at least 8 characters",
  ...
  rechargeDetailDesc11:
    "Make sure the payment has been completed, if not, please return to make the payment",
  ...
  instructionTxt9:
    "Minimum withdrawal amount, 10 usdt, Deposit less than 10 usdt will not receive",
  instructionTxt10:
  ...
  orderDesc1:
    "If you have already paid, please do not cancel the order to avoid any loss for you",
  orderDesc2:
    "If you have already transferred the money to the recipient, Please do not press cancel the transaction!",
  ...
  titleGot: "Receive",
  dailyRateReturn:
    "Daily interest rate {0}%  + VIP extra income safe, calculated every {1} minute",
  prompt: "Notification",
  ...
  c2cNEWUPIW:
    "Use UPI to withdraw money, every withdrawal is rewarded with an additional {0}% bonus",
  ...
  c2cInstructions2:
    "Use C2C for deposits, each deposit will get an additional 2% bonus;",
  c2cInstructions3:
  ...
  c2cRechargeUpiSheet2:
    "Choose deposit with the amount below to get deposit bonus",
  award: "Bonus",
  ...
  c2cTip5:
    "Complaint is being processed, please wait for customer service handling",
  ...
  c2cTip13:
    "The order has expired, please confirm immediately after receiving the money",
  ...
  bcTip2:
    "To ensure a successful withdrawal, please bind your personal personal bank account which is still functioning properly",
  IFSCCode: "IFSC code",
  toBind: "Bind",
  ...
  c2cFTip1:
    "Use<span data-v-b47de12f>{0}</span>，every withdrawal gives an extra<span data-v-b47de12f>{1}%</span>bonus；",
  c2cFTip2:
    "The withdrawal amount must be an integer of <span data-v-b47de12f>{0}</span>",
  c2cFTip3:
    "After the sender completes the payment, click <span data-v-b47de12f>【Money received】</span>",
  ...
  UTRError: "UTR error",
  c2cTip16:
    "To protect your rights and interests, please enter the 12-digit UPI Ref.ID",
  ...
  channel: "Channel {0}",
  instructionsDesc1:
    "Minimum deposit: {0} , deposits less than {1}  will not be credited",
  instructionsDesc2:
    "Do not deposit any non-currency assets to the above address, or the assets will not be recovered.",
  instructionsDesc3:
    "Please confirm that the operating environment is safe to avoid information being tampered with or leaked.",
  ...
  idlockTip3:
    "For account security, please complete account security verification",
  ...
  resultsVielottery:
    "Vietnam lottery results will be based on the official results of the provincial lottery",
  systemresult:
  ...
  oncebetgenerated:
    "Once the bet is generated (the bet is successful), it can be canceled in the betting record.",
  anyreasonCauses:
    "Any reason why bets are made after the draw close time will be considered invalid bets!",
  platformcancel:
    "The Platform may cancel the bet, resulting in the following cases:",
  drawdelayedtoolong: "Delayed prize draw for too long",
  resultsofthelotterybeenleaked:
    "Lottery results were leaked before closing or before drawing time",
  maximumprofitsingleperiod:
    "The maximum accumulated profit in 1 period is 700,000,000 VND (excluding principal)",
  ...
  sorthlotteryresult:
    "Example results of lottery drawing in central and southern regions",
  ...
  tipvietnamlottery6:
    "The system will automatically form 3 groups of 4 . skewers",
  tipvietnamlottery7:
  ...
  sure: "Sure",
  vipTip4:
    'Successfully received<span class="red">{0}</span> points and <span class="yellow">{1}</span> balance',
  ...
  allSelectbetsCannot:
    "2D all pick bets cannot be purchased more than 100 numbers",
  thenumberofallbettingexceed:
    "2 parlay bets cannot be purchased more than 100 numbers",
  threenumberofallbettingexceed:
    "3 parlay bets cannot be purchased more than 100 numbers",
  fournumberofallbettingexcedd:
    "4 parlay bets cannot be purchased more than 100 numbers",
  firstprizenumberofallbettingexceed:
    "Jackpot Mantissa bets cannot be purchased more than 100 numbers",
  code343: "Bet the wrong number",
  duplexthreecomplete:
    "3 parlay bets cannot be purchased more than 150 numbers",
  ...
  regTip5:
    "Password must contain uppercase and lowercase letters A-Z and numbers 0-9 and have more than or equal to 8 digits",
  ...
  instructions3:
    "Gambling Is Addictive, Please Play It Wisely. {0} Only Accepts Customers over the Age of 18",
  bigPrice: "Winning Multiple",
  flashDesc:
    "The Internal Game Is Independently Developed by the {0} Team, Which Is Fun, Fair and Safe",
  ...
  addupiTip:
    "The Phone Number Is Wrong, Didn't Receive the Verification Code, Please Contact Customer Service !",
  code264: "The Order Is in Confirmed Status",
  code273: "The Order Is in Canceled Status",
  code292: "The Order Is in Pending Status",
  code265:
    "Existing Order Transaction Number_please Enter Correct Transaction Number",
  ...
  googleTip3:
    "For the security of your account and funds, please fill in and verify your identity first.",
  ...
  googleTip5:
    "Open Google Authenticator, please enter a 6-digit security verification code",
  googleTip6:
  ...
  WaveTip1:
    "In order to ensure your financial security, please bind your account",
  rechargeBankVailte:
    "Please enter the name and mobile phone number consistent with the transfer account!",
  ...
  xosoTxt1:
    "Select 1 number from ten digits and individual digits to form a set of 2 digits for betting",
  xosoTxt2:
  ...
  xosoTxt3:
    "{0} Group number has the last 2 digits of 45, which is the winning. If the number of {0} group number has n's last 2 digits of 45, the reward is multiplied by N.",
  xosoTxt4:
  ...
  xosoTxt6:
    "{0} group number has the last 2 digits of 45, which is the winning. If the number of the {0} group number has n's last 2 digits of 45, the reward is multiplied by n.",
  xosoTxt8:
    "Select 1 number to form a set of 3 digits from the hundred digits and ten digits for betting.",
  xosoTxt9:
    "{0} group number has the last 3 digits of 456, which is the winning prize. If the number of the {0} group number has n's last 3 digits of 456, the reward is multiplied by N.",
  xosoTxt10:
  ...
  xosoTxt14:
    "{0} Group number has the last 2 digits of 45 and 55, which is the winning prize.",
  xosoTxt15:
    "{0} Group number has the last 2 digits with 45/55/65, which is the winning.",
  xosoTxt16:
    "{0} Group number has the last 2 digits with 45/55/65/75, which is the winning prize.",
  xosoTxt17:
    "If the voting number matches the last 2 digits of the award of the lottery results, it is the winning.",
  xosoTxt18:
  ...
  xosoTxt21:
    "If the voting number matches the top 2 digits of the award of the lottery results, it is the winning.",
  xosoTxt22:
    "If the voting number matches the last 2 digits of the award of the lottery results, it is the winning.",
  ...
  xosoTxt30:
    "If the selected number is consistent with the ten -digit prizes in the lottery results, win the prize.",
  xosoTxt31: "The ten special prizes are 4, so you win.",
  xosoTxt32:
    "If the voting number matches the first two digits of the award of the lottery results, it is the winning.",
  xosoTxt33:
    "The special prize of the units row is number 4, then you have won.",
  xosoTxt34:
    "If the voting number matches the last 2 digits of the prize prize result, it is the winning.",
  xosoTxt35:
    "The last two prizes of the draw results are 45, which is the winning.",
  xosoTxt36:
    "If the voting number matches the first two digits of the first prize of the lottery, it is the winning.",
  xosoTxt37:
    "The top 2 of the first prize of the lottery is 45, and it is the winning.",
  xosoTxt38:
    "Select a number from the hundred, ten and individual digits to form a 3 -digit betting",
  xosoTxt39:
    "If the number of the voting is matched with the number of the six -class prize in the results, it is a winning.",
  xosoTxt40:
    "If the number of the voting is matched with the number of the seventh prize in the results, it is a winning.",
  xosoTxt41:
  ...
  xosoTxt43:
    "Select 1 number from 100 digits and ten digits to form a set of 3 digits for betting",
  xosoTxt44:
    "If the voting number matches the last 3 digits of the lottery results, it is the winning.",
  xosoTxt45: "The last 3 of the special prize is 456, which is the winning.",
  xosoTxt46:
    "If the voting number matches the last 3 digits of the prize prize, it is the winning.",
  xosoTxt47:
    "If the voting number matches the last 3 digits of the prize prize, it is the winning.",
  xosoTxt48:
  ...
  xosoTxt52:
    "If the voting number matches the last 4 digits of the lottery results, it is the winning.",
  ...
  xosoTxt57:
    "{0} group number does not have the last 2 digits with 45/55/66/77, and it is the winning.",
  xosoTxt58:
    "{0} group number does not have the last 2 digits with 45/55/66/77/88/99/11/22, which is the winning prize.",
  xosoTxt59:
    "{0} Group number does not have the last 2 digits 45/55/66/77/88/99/11/22/33/44, which is the winning prize.",
  xosoTxt60: "Harmony",
  xosoTxt61:
  ...
  xosoTxt64:
    "The value of the peace is considered to be a bureau, and the principal is refunded.",
  xosoTxt65:
    "The two digits after the special prize are opened plus the sum of the ten digits.",
  xosoTxt66:
    "The number of openings is 24, 2+4 = 6, which is dual number. If you open 00, it is also a double number.",
  xosoTxt67:
    "After the two digits of the special prizes, the two digits of the award plus the sum of the ten digits are 'singles'.",
  ...
  upiInstructions2:
    "If you are wrong when you create an order, the loss of customer , our company will not responsible !",
  ...
  code39:
    "Unauthorized red envelope collection, please contact the administrator",
  code40:
    "Points redemption is not authorized, please contact the administrator",
  promotionData: "promotion data",
  emailUndetected: "Email not detected",
  tipemaildigitVeriCode:
    "Please enter the 6-digit verification code of email address {0}",
  ...
  verificationcodegoogle:
    "The Google Authenticator security code is valid for 30 seconds, please enter the verification code within the validity period",
  rechargeBankVailte1:
    "Please enter the same name and bank card number as the transfer account!",
  ...
  trxRule:
    "By obtaining the real-time hash value of the TRX blockchain as the result of the lottery",
  k3Rule:
    "The player predicts 3 DICE numbers, the winning rate is high, the gameplay is simple, and it is easy to win",
  d5Rule:
    "5 numbers are used as the result of the lottery, and the playing methods are flexible and diverse",
  makeBet: "make a bet",
  ...
  damanRule:
    "The Daman platform advocates fairness, justice, and openness. We mainly operate fair lottery, blockchain games, live casinos, and slot machine games.",
  damanRule2:
    "Daman works with more than 10'000 online live game dealers and slot games, all of which are verified fair games.",
  damanRule3:
    "Daman supports fast deposit and withdrawal, and looks forward to your visit.",
  ...
  xosoRule:
    "Official lottery results obtained through xoso in North, Central and South Vietnam",
  vipTip16: "VIP level downgrade",
  pswRule:
    "The password must be at least 8 digits and must contain letters + numbers",
  addedFailed: "add failed",
  bindsuccess: "bind successfully",
  vipTip17:
    "Relegation failed, experience points deducted and downgraded [VIP{0}]",
  ...
  rpwdEmailPopupTip:
    "Unable to receive email verification code, please contact customer service",
  ...
  xosoTxt102:
    "If the selected number matches the single digit of the special prize in the lottery result, you win.",
  ...
  activityTip6:
    "Rewards are available upon completion of tasks every week day/day",
  ...
  rechargeLevelNumber:
    "Number of first-time depositors under direct subordinates",
  ...
  c2cWTip7:
    "You can choose to continue matching or change the amount, or you can choose to cancel the withdrawal",
  ...
  promotionRuleDesc6:
    "The calculation of yesterday's commission starts every morning at {0}. After the commission calculation is completed, the commission is rewarded to the wallet and can be viewed through the commission collection record.",
  ...
  firstSaveItemTip:
    "Deposit {0} for the first time in your account and you can receive {1}",
  ...
  xosoTip1:
    "The bet failed. This method does not allow bets to exceed the number {0}.",
  xosoTip2: "The maximum bet in a single period cannot exceed {0}",
  xosoTip3:
    "You cannot bet on big and small or odd and even in the same period.",
  xosoTip4:
    "A single bet on different numbers is limited to a maximum of 5 groups of bets.",
  C2Ctimeout1: "Order has timed out",
  C2Ctimeout2:
    "The payment for this order has timed out, please create a new order.",
  firstSave: "First deposit",
  firstSaveT: "Deposit {0} for the first time and you will receive {1} bonus",
  notNecessary: "Optional",
  superJackpotTxt:
    "The reward is valid for {0} day, and you will not be able to claim it after it expires!",
  code8108: "C2C Withdraw Awards",
  c2cState13: "Processing",
  c2cTip23:
    "Click [Confirm Arrival] and the reward will be distributed to your wallet balance.",
  c2cTip24:
    "Order matching is successful and waiting for payment from the other party",
  ...
  code347:
    "You cannot place bets on odd and even numbers in the same issue at the same time",
  code348: "The bet fails. This game does not allow bets to exceed",
  code349:
    "Different single purchases are limited to a maximum of 5 groups of purchases",
  ...
  receiveAllSuccess:
    "All super prizes have been successfully collected in batches",
  ...
  c2cFTip4:
    "After clicking [Money received], the reward will be distributed to your wallet balance.",
  MyLottery: "my draw",
  ...
  code285:
    "The order has been matched successfully and cannot be matched again",
  proRule1:
  ...
  playerEnd:
    "The ticket sales period has ended. Please purchase from 6:00 am to 9:55 pm every day.",
  binguoRuleTipText1:
    "Predict the outcome of 3 dice, you can bet 3 to 18, you can also bet big - and - small",
  binguoRuleTipText2:
    "Predict 3 numbers and if 3 identical numbers appear, you will win.",
  binguoRuleTipText3:
    "If you predict 3 numbers and 2 of them are the same, you will win.",
  binguoRuleTipText4:
    "If you predict 3 numbers and one of the same numbers appears, you will win.",
  ...
  binguoRuleText3:
    "Each period has 3 numbers as the opening numbers, and the numbers are natural numbers from 111 to 666.",
  ...
  binguoRuleText12:
    "If the lottery result is the same as the betting number, you will win.",
  binguoRuleText13:
  ...
  binguoRuleText16:
    'Bet on any three identical "***" numbers, and if the result is any three identical numbers, you will win.',
  ...
  amountError1:
    "The other party has submitted an application with an incorrect amount.",
  C2Cuploadtip3:
    "Please confirm that you have completed the payment. Please upload the payment voucher after payment.",
  ...
  cpsTip12:
    "<span>{0}</span>The tournament will begin <span>{1}</span> and end <span>{2}</span>.",
  ...
  cpsTip17:
    "Leaderboard ranking will be determined based on each player's total bets during the tournament.",
  cpsTip18:
    "The player with the highest total bet amount will be declared the winner of the tournament.",
  ...
  Play4DTip1:
    'The first prize number<font class="red">{0}</font> is the winning number',
  Play4DTip2:
  ...
  cpsTip25:
    "You can participate in the tournament after betting {0} in the game within the event",
  ...
  withdrawTip3:
    "Please come back and click [Confirm Payment] after receiving the transfer",
  withdrawTip4:
    "C2C withdrawal rewards will be automatically issued after you click <span>[Confirm Arrival]</span>!",
  ...
  registrationFullTip:
    "Membership bonuses after registering for {0} days are as follows:",
  ...
  registrationDepositTip:
    "Registered for {0} days and accumulated deposits {1}+",
  registrationExample:
  ...
  turntableSatisfy:
    "Members who meet the requirements of <span>{0}</span> can participate in the bigwheel event. Need to bind a bank card. Hundreds of millions of cash and many other prizes are up for grabs. Get ready for endless surprises and grand prizes every day!",
  ...
  turntableRule3:
    "Conditions for withdrawal of wheel rewards: <span>1</span> times turnover required.",
  turntableRule4:
  ...
  turntableRule5:
    "The lottery round starts every morning at <span>00:00</span>. After making your deposit, you need to wait 5 minutes before the draw wheel starts.",
  turntableExample:
    "If a member's single deposit exceeds <span>{0}</span> on the same day, he or she will receive <span>{1}</span> lucky draw opportunities. The lottery draws are valid for the same day and cannot be accumulated to the next day!",
  ...
  code246:
    "The maximum limit for receving red envelopes for today has been reached",
  transferType: "Transfer type",
  banktobank: "bank to bank",
  wallettobank: "wallet to bank",
  rechargeBankVailte2:
    "Please enter the name and account number that are consistent with the transfer account number",
  ...
  arTip:
    "ARB is an officially issued encrypted digital currency, referred to as ARB. It is recommended to use ARB for recharge.",
  arGift: "Use AR PAY to recharge for additional rewards {0} bonus",
  loading: "loading",
  ...
  haveArpayOrderTip:
    "You already have an uncompleted recharge order, please complete it first",
  ...
  invitationFrind: "Invite friends to get rewards",
  invitationCount: "Inviation count",
  invitationEffective: "Effective Inviation count",
  invitationTotalBonus: "Inviation total bonus",
  invitationLink: "Inviation link",
  partnerRule:
    "eg: <br/> if player A invites player B to make their first deposits,<br/>player A will receive a bonus of {0}",
  partnerRule2:
  ...
  bigLotteryTip7:
    "Friendly reminder: The more raffle tickets you have, the higher your chances of winning",
  ...
  bigLotteryTip15:
    "The system on the next day {0} will select {1} lucky winners",
  ...
  bigLotteryTip24:
    "【Super Lottery】everyday <span>{0}</span> will draw a lottery,each draw will select <span>{1}</span> users, will draw <span>{1}</span>users will share the day's jackpot money",
  bigLotteryTip25:
    "The more lottery tickets you exchange, the higher your chances of winning",
  bigLotteryTip26: "How to claim bonus",
  bigLotteryTip27:
    "The bonus will be automatically credited to the member's balance, and there are no wagering requirements for the winnings from the Big Lottery. The winnings can be withdrawn directly.",
  bigLotteryTip28:
  ...
  bigLotteryTip30:
    "【Super Lottery】is a periodic activity, and it may close at any time",
  ...
  bigLotteryTip35:
    "The bonus has been automatically deposited into your wallet balance.",
  bigLotteryTip36: "1.Earn points by inviting others",
  bigLotteryTip37:
    'Invite friends to register and top up any amount to earn<span class="red">{0}</span> points',
  ...
  bigLotteryTip42:
    "The platform gives players different points based on their daily recharge amount",
  deposit: "Deposit",
  giveAway: "Give away",
  ...
  bigLotteryTip46:
    "Participate in the daily event to share the million-dollar jackpot",
  bigLotteryTip47:
    "You can participate by exchanging points for lottery tickets",
  bigLotteryTip48: "Historical jackpot",
  code193: "CPF and PIX account contents are inconsistent",
  pixTip1:
    "The contents of CPF and PIX accounts are inconsistent, please confirm and submit again!",
  ...
  GoGame: "Go Game",
  Terms:
    "Justice, and openness. We mainly operate fair lottery.The platform advocates fairness, blockchain games, live casinos, and slot machine games",
  Terms2:
    "Blockchain games, live casinos,and slot machine Works with over 10,000 online live game dealers and slot games, all verified fair games",
  ...
  c2cNEWUPIWiOS:
    "Use UPI to withdraw money, every withdrawal is rewarded with an additional %.0f%@ bonus",
  highestRebateiOS: "Permanent commission<span>up to</span>%d%@",
  instructionsDesc1ios:
    "Minimum deposit: %d , deposits less than %d will not be credited",
  underDevelopment: "Under Development",
  tip6digitVeriCodeios: "Please enter the %@ %d-digit verification code",
  tipemaildigitVeriCodeios:
    "Please enter the 6-digit verification code of email address %@",
  arbTip13: "My ARB",
  ...
  tipInterpretationRightSavedios:
    "The final interpretation of this activity belongs to %@",
  promotionRuleDesc6ios:
    "The calculation of yesterday's commission starts every morning at %@. After the commission calculation is completed, the commission is rewarded to the wallet and can be viewed through the commission collection record.",
  abbTip9ios:
    "You only need<span>%@</span>to withdraw the balance to AR Wallet",
  arbTip10ios:
