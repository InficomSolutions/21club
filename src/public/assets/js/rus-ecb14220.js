const e = {
  ...
  promotionRuleDesc4:
    "Depending on the amount of the refund, the rate of refund is different.",
  promotionRuleDesc5:
  ...
  code316:
    "The balance recovery request time is 30 seconds. Please try again later",
  code317:
  ...
  oncebetgenerated:
    "Once a bet is confirmed (successful bet), it cannot be canceled or changed.",
  anyreasonCauses:
  ...
  delAllTip2:
    "After deleting the data cannot be recovered, please do it carefully",
  ...
  xosoTxt33:
    "The top 2 of the award of the lottery results is 45, and it is the winning.",
  xosoTxt34:
  ...
  upiInstructions2:
    "If you are wrong when you create an order, the loss of the company is not responsible!",
